...
public static class ChartThemeVariants
{
    ...
    public static ChartThemeVariant Default { get; } = new(nameof(ThemeConstants.Themes.Default),
        SKTypeface.FromFamilyName("Inter, sans-serif", SKFontStyleWeight.SemiBold, SKFontStyleWidth.Normal,
            SKFontStyleSlant.Upright), new List<ChartColor>
        {
    ...
    private static ChartThemeVariant Classic { get; } = new(nameof(ThemeConstants.Themes.Classic),
        SKTypeface.FromFamilyName("Inter, sans-serif", SKFontStyleWeight.SemiBold, SKFontStyleWidth.Normal,
            SKFontStyleSlant.Upright), new List<ChartColor>
        {
    ...
    private static ChartThemeVariant Lime { get; } = new(nameof(ThemeConstants.Themes.Lime),
        SKTypeface.FromFamilyName("Inter, sans-serif", SKFontStyleWeight.SemiBold, SKFontStyleWidth.Normal,
            SKFontStyleSlant.Upright), new List<ChartColor>
        {
            new(ChartColors.FirstAccent, new(157, 105, 242)),
